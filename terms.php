...
<head>
    ...
    <title>Syarat & Ketentuan - Chocloud</title>
...
<body class="bg-gray-50">
    ...
    <main class="pt-24 pb-16">
      <div class="container mx-auto px-6 md:px-20 max-w-4xl bg-white p-8 md:p-12 rounded-lg shadow-md">
        <h1 class="text-4xl font-extrabold text-center mb-2">Syarat & Ketentuan</h1>
        <p class="text-center text-gray-500 mb-8">Terakhir diperbarui: 1 Agustus 2025</p>

        <div class="prose max-w-none">
            <h2>1. Penerimaan Syarat</h2>
            <p>Dengan mengakses dan menggunakan situs web ini, Anda setuju untuk mematuhi dan terikat oleh Syarat dan Ketentuan penggunaan ini. Jika Anda tidak setuju dengan bagian mana pun dari syarat-syarat ini, Anda tidak diperkenankan menggunakan situs web kami.</p>

            <h2>2. Produk dan Harga</h2>
            <p>Kami berusaha untuk menampilkan informasi produk, termasuk deskripsi dan harga, seakurat mungkin. Namun, kami tidak menjamin bahwa semua informasi tersebut bebas dari kesalahan. Harga dapat berubah sewaktu-waktu tanpa pemberitahuan. Semua pesanan bergantung pada ketersediaan produk.</p>

            <h2>3. Pemesanan</h2>
            <p>Pemesanan produk dilakukan melalui platform pihak ketiga seperti Shopee dan WhatsApp. Setiap transaksi yang terjadi di platform tersebut tunduk pada syarat dan ketentuan dari masing-masing platform.</p>

            <h2>4. Kebijakan Pengembalian</h2>
            <p>Karena sifat produk kami yang merupakan makanan, kami tidak menerima pengembalian barang atau pengembalian dana kecuali jika produk yang diterima salah atau rusak saat tiba. Untuk klaim produk yang salah atau rusak, pelanggan wajib menyertakan video unboxing tanpa jeda maksimal 1x24 jam setelah produk diterima.</p>

            <h2>5. Hak Kekayaan Intelektual</h2>
            <p>Seluruh konten yang terdapat di situs ini, termasuk namun tidak terbatas pada teks, grafik, logo, dan gambar, adalah milik Chocloud by Nadi dan dilindungi oleh undang-undang hak cipta. Dilarang menggunakan, mereproduksi, atau mendistribusikan konten apa pun dari situs ini tanpa izin tertulis dari kami.</p>

            <h2>6. Batasan Tanggung Jawab</h2>
            <p>Chocloud by Nadi tidak akan bertanggung jawab atas kerusakan tidak langsung, insidental, atau konsekuensial yang timbul dari penggunaan atau ketidakmampuan untuk menggunakan situs web atau produk kami.</p>

            <h2>7. Perubahan pada Syarat & Ketentuan</h2>
            <p>Kami berhak untuk memperbarui atau mengubah Syarat & Ketentuan ini kapan saja tanpa pemberitahuan sebelumnya. Penggunaan Anda atas situs web ini setelah perubahan tersebut merupakan persetujuan Anda untuk mengikuti dan terikat oleh Syarat & Ketentuan yang telah diubah.</p>
        </div>
      </div>
    </main>
